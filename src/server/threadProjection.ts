	...
	createThread(
		...
		return this.runInTransaction(() => {
			...
			const thread: ControlThread = {
				...
				parentThreadId: input.runtimeThread.parentThreadId,
				sourceKind: input.runtimeThread.sourceKind,
				agentNickname: input.runtimeThread.agentNickname,
				agentRole: input.runtimeThread.agentRole,
