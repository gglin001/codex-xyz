...
export const tone = {
	...
	selected: {
		...
		strong:
			"border-accent-soft bg-selected-strong text-fg-strong shadow-[0_0_0_1px_rgba(168,200,255,0.10)]",
	},
	running: {
...
export const ui = {
	...
	controlBase,
	iconButton: `inline-flex h-8 min-w-8 items-center justify-center ${radius.control} border border-border bg-control text-muted-strong shadow-control ${interactiveTransition} hover:border-border-strong hover:bg-control-hover hover:text-fg-strong ${focusRing} ${disabledState} ${pressState}`,
	largeIconButton: `inline-flex h-9 w-9 shrink-0 items-center justify-center ${radius.nav} border border-transparent bg-transparent text-muted-strong shadow-none ${interactiveTransition} hover:border-border hover:bg-control hover:text-fg-strong active:bg-control-hover active:text-fg-strong ${focusRing} ${disabledState} ${pressState}`,
	composerIconButton: `inline-flex h-8 min-w-8 items-center justify-center ${radius.control} border border-transparent bg-transparent text-muted-strong ${interactiveTransition} hover:bg-control hover:text-fg-strong disabled:cursor-not-allowed disabled:opacity-35 ${focusRing} ${pressState}`,
	composerShell: `grid min-h-[104px] gap-2 ${radius.panel} border border-border-strong bg-field px-3.5 py-3 shadow-panel ${interactiveTransition} focus-within:border-accent-soft focus-within:bg-detail/50 focus-within:ring-2 focus-within:ring-focus-ring`,
	submitButton: `inline-flex h-8 min-w-[72px] shrink-0 items-center justify-center gap-1.5 ${radius.control} border border-accent-soft bg-accent px-3 text-[13px] font-semibold text-accent-fg ${interactiveTransition} hover:border-accent hover:bg-accent disabled:cursor-not-allowed disabled:border-border-soft disabled:bg-surface-subtle disabled:text-muted`,
	buttonControl: `inline-flex items-center justify-center ${controlBase}`,
	surfaceButton: `flex min-w-0 items-center text-left ${radius.control} border border-border bg-detail text-fg shadow-card ${staggeredTransition} hover:border-border-strong hover:bg-control hover:text-fg-strong ${focusRing} ${disabledState} ${pressState}`,
	...
	navSelected:
		"border border-border-strong bg-selected text-fg-strong shadow-control",
	segmented: `inline-flex items-center ${radius.controlLg} border border-border bg-surface-subtle p-0.5 text-muted shadow-control`,
	...
	field: `${radius.control} border border-border bg-field text-muted shadow-control ${interactiveTransition} focus-within:border-border-strong focus-within:bg-surface-subtle focus-within:text-fg ${focusRing}`,
	input:
	...
	pill: "inline-flex h-5 shrink-0 items-center justify-center gap-1 rounded-full border border-border bg-control px-1.5 text-[11px] font-medium leading-none text-fg",
} as const;
